<?php 
   ...
   $img_directory = 'img-load-manager/gallery-images';
   
   $images = glob("$img_directory/*{jpg,png,jpeg}", GLOB_BRACE); // Makes an array of every image saved in the selected directory
...
<body>
   ...
   <?php 
      ...
      echo '<script src="img-load-manager/img_script.js" defer></script>'
